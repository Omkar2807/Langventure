          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="relative z-10">
              ...
              <p className="text-xl text-neutral-600 mb-8 animate-fade-in delay-100">
                Join millions of users worldwide and start your language journey
                today!
              </p>
                ...
                <ClerkLoaded>
                  <SignedOut>
                    <SignUpButton mode="modal">
                      <Button
                        size="lg"
                        className="bg-green-600 text-white hover:bg-green-700 transition-all transform hover:scale-105 "
                      >
                        Get Started
                      </Button>
                    </SignUpButton>
                    <SignInButton mode="modal">
                      <Button
                        size="lg"
                        className="text-green-600 border-green-600 hover:bg-green-50 transition-all transform hover:scale-105"
                      >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-neutral-50 p-8 rounded-lg shadow-md hover:shadow-lg transition-all transform hover:-translate-y-2">
                ...
                <p className="text-neutral-600">
                  Engage with fun, game-like lessons that make learning
                  addictive.
                </p>
              </div>
              <div className="bg-neutral-50 p-8 rounded-lg shadow-md hover:shadow-lg transition-all transform hover:-translate-y-2">
                ...
                <p className="text-neutral-600">
                  Track your progress and celebrate milestones as you learn.
                </p>
              </div>
              <div className="bg-neutral-50 p-8 rounded-lg shadow-md hover:shadow-lg transition-all transform hover:-translate-y-2">
                <div className="text-green-600 mb-4">
                ...
                <p className="text-neutral-600">
                  Join a global community of learners and practice together.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-all transform hover:-translate-y-2">
                <p className="text-neutral-600 italic">
                  "LangVenture has transformed the way I learn languages. The
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-neutral-50 p-8 rounded-lg shadow-md hover:shadow-lg transition-all transform hover:-translate-y-2">
                ...
                <p className="text-neutral-600">
                  Simply sign up for an account and start exploring our
                  interactive lessons.
                </p>
              </div>
              <div className="bg-neutral-50 p-8 rounded-lg shadow-md hover:shadow-lg transition-all transform hover:-translate-y-2">
